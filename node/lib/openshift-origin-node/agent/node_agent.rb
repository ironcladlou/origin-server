    ...
    class NodeAgent
      ...
      def app_create(args)
        ...
        begin
          ...
          script = "/opt/rh/ruby193/root/usr/share/gems/gems/openshift-origin-node-1.19.1/lib/openshift-origin-node/agent/gear_agent.rb"
          job = fork { exec "nohup #{script} #{container.uuid}" }
          Process.detach(job)
